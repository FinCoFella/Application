...
pdf_path = "/home/fincofella/dev/Application/10QK_PDFs/RF/RF_3Q24_10Q.pdf"
tables = tabula.read_pdf(pdf_path, pages=72, multiple_tables=True, stream=True)
...
CSV = SCRIPT_DIR / "RF_3Q24_cre.csv"
