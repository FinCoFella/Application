...
pdf_path = "/home/fincofella/dev/Application/10QK_PDFs/AMT/AMT_2024_10K.pdf"
ticker   = "AMT"
quarter  = "4Q24"

# Adjust
page_specs = {
    180: {"table_idx": 0, "row_slice": slice(6, 47), "col_idxs": [1, 8]},
    182: {"table_idx": 0, "row_slice": slice(0, 8), "col_idxs": [1, 8]},
}
...
CSV = SCRIPT_DIR / "AMT_4Q24_unsecured_debt.csv"
