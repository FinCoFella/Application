...
pdf_path = "/home/fincofella/dev/Application/10QK_PDFs/AMT/AMT_2Q24_10Q.pdf"
ticker   = "AMT"
quarter  = "2Q24"

# Adjust
page_specs = {
    22: {"table_idx": 2, "row_slice": slice(6, 12), "col_idxs": [1, 5]},
    24: {"table_idx": 0, "row_slice": slice(0, 42), "col_idxs": [1, 5]},
}
...
CSV = SCRIPT_DIR / "AMT_2Q24_unsecured_debt.csv"
