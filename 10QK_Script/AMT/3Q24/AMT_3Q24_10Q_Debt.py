...
pdf_path = "/home/fincofella/dev/Application/10QK_PDFs/AMT/AMT_3Q24_10Q.pdf"
ticker   = "AMT"
quarter  = "3Q24"

# Adjust
page_specs = {
    24: {"table_idx": 2, "row_slice": slice(6, 12), "col_idxs": [1, 5]},
    26: {"table_idx": 0, "row_slice": slice(0, 42), "col_idxs": [1, 5]},
}
...
CSV = SCRIPT_DIR / "AMT_3Q24_unsecured_debt.csv"
