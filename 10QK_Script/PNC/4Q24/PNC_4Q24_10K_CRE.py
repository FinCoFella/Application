...
# Adjust
pdf_path = "/home/fincofella/dev/Application/10QK_PDFs/PNC/PNC_2024_10K.pdf"
# Adjust
tables = tabula.read_pdf(pdf_path, pages=123, multiple_tables=True, stream=True)
...
CSV = SCRIPT_DIR / "PNC_4Q24_cre.csv"
