...
# Adjust
pdf_path = "/home/fincofella/dev/Application/10QK_PDFs/WELL/WELL_2Q24_10Q.pdf"

area = [70, 20, 260, 560]
columns = [330, 435, 520]

tables = tabula.read_pdf(pdf_path, pages=25, stream=True, guess=False, area=area, columns=columns, multiple_tables=False, pandas_options={"header": None})
...
CSV = SCRIPT_DIR / "WELL_2Q24_unsecured_debt.csv"
