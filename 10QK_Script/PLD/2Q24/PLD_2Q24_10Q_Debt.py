...
# Adjust
pdf_path = "/home/fincofella/dev/Application/10QK_PDFs/PLD/PLD_2Q24_10Q.pdf"
# Adjust
tables = tabula.read_pdf(pdf_path, pages=30, multiple_tables=True, stream=True, pandas_options={"header": None})
...
CSV = SCRIPT_DIR / "PLD_2Q24_unsecured_debt.csv"
