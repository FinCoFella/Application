...
# Adjust
pdf_path = "/home/fincofella/dev/Application/10QK_PDFs/HBAN/HBAN_2Q24_10Q.pdf"
# Adjust
tables = tabula.read_pdf(pdf_path, pages=21, multiple_tables=True, stream=True)
...
CSV = SCRIPT_DIR / "HBAN_2Q24_cre.csv"
