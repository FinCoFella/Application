from SNV_3Q24_10Q_CRE_v1 import extract_cre_main_table
from SNV_3Q24_10Q_CRE_v2 import extract_cre_other_table
import pandas as pd
...
print("\n=============== Merged CRE 3Q24 Loan Portfolio Table ================")
print(final_df, "\n")
...
CSV = SCRIPT_DIR / "SNV_3Q24_cre.csv"
