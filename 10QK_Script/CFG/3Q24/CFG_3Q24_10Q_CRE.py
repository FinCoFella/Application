...
pdf_path = "/mnt/c/Users/finco/OneDrive/Documents/Filings/Financials/10QK/CFG/CFG_3Q24_10Q.pdf"
...
property_df = property_df[
    ~property_df["CRE Property Type"].isin([
        ...
        "Data center",
        "Other",
        "Total CRE"  # Recalculate this
    ])
]

new_rows = pd.DataFrame([
    {
        "Ticker": "CFG", "Quarter": "3Q24", "CRE Property Type": "Office",
        "Loan Amount": office_total, "Unit": "mn", "Currency": "USD", "Category": "CRE"
    },
    {
        "Ticker": "CFG", "Quarter": "3Q24", "CRE Property Type": "Other",
