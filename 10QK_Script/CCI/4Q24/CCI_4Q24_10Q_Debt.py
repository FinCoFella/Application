...
# Adjust
pdf_path = "/home/fincofella/dev/Application/10QK_PDFs/CCI/CCI_2024_10K.pdf"
# Adjust
tables = tabula.read_pdf(pdf_path, pages=91, multiple_tables=True, stream=True, pandas_options={"header": None})
...
raw = tables[0]
# Adjust
debt_maturity_df = raw.iloc[7:38, [3, 6]].copy()
...
CSV = SCRIPT_DIR / "CCI_4Q24_unsecured_debt.csv"
