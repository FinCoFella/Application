...
image_path = "Images/CFG/CFG_4Q24_CRE.png"
...
instruction_text = (
    ...
    f"Combine 'Other general office' and 'Credit tenant lease and life sciences' property rows into a single 'Office' property type row in the final table."
    f"Combine 'Other', 'Co-op', and 'Data Center' into a single 'Other' property row."
