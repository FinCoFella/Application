...
prompt = (f"""
    ...
    Combine 'Other general office' and 'Credit tenant lease and life sciences' property rows into a single 'Office' property type row in the final table.
    Combine 'Other', 'Co-op', and 'Data Center' into a single 'Other' property row.
