...
CIK = '0000766704' # WELL CIK Number
HEADERS = {"User-Agent": "Nik (nd24@ic.ac.uk)"}
CSV = "WELL_10QK_EBITDA.csv"

RECENT_QUARTERS = 10
RECENT_YEARS = 5  
ABS_SIGN_FACTS = {"InterestExpenseDebt": True, "InterestExpenseBorrowings":  True,}
...
def switch_ie_df(data: dict) -> pd.DataFrame:
    ...
    ie_v1 = safe_get_fact_df(data, "InterestExpenseDebt")            
    ie_v2 = safe_get_fact_df(data, "InterestExpenseBorrowings")
